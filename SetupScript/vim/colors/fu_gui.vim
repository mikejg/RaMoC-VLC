...
hi FoldColumn     ctermfg=248 ctermbg=bg  guifg=#a8a8a8 guibg=#000000 guibg=bg  
...
hi SpellBad       ctermfg=196 ctermbg=52 guifg=#ff0000 guibg=#5f0000
...
hi diffAdd      ctermfg=bg    ctermbg=151 guifg=#000000 guibg=#afd7af guifg=bg
hi diffDelete   ctermfg=bg    ctermbg=246 guifg=#000000 guibg=#949494 guifg=bg
hi diffChange   ctermfg=bg    ctermbg=181 guifg=#000000 guibg=#d7afaf guifg=bg    
hi diffText     ctermfg=bg    ctermbg=174 guifg=#000000 guibg=#d78787 guifg=bg    
...
hi rubyInstanceVariable      ctermfg=189 guifg=#d7d7ff
