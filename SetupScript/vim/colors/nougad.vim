...
"
" History:
"   2010-06-09  Fixed whitespaces. Made background transparent. Set only
"   background on visual mode. Made selection lighter. Removed unknown
"   Identifiers (diffAdded,diffRemoved). Use only background color for diffs.
"   Removed rubyInstanceVariable - was with white highlighting. No background
...
hi NonText        ctermfg=248   ctermbg=NONE   cterm=bold
...
hi diffText                     ctermbg=20    cterm=bold
