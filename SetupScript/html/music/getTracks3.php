...
$query="SELECT m_title.id, m_title.title, m_artist.name, m_album.name, ";
$query.="m_title.wertung, m_title.album, m_title.artist, m_album.artist, ";
$query.="m_title.gespielt, m_title.pfad FROM m_title ";
