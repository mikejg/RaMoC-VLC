...
$query.="WHERE (serie = 0 AND archives = 1 AND g1.genre1 = '" . $genre . "') ";
$query.="OR (serie = 0 AND archives = 1 AND g2.genre2 = '" . $genre . "') ";
$query.="OR (serie = 0 AND archives = 1 AND g3.genre3 = '" . $genre . "') ";
$query.="OR (serie = 0 AND archives = 1 AND g4.genre4 = '" . $genre . "') ";
